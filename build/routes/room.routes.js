...
roomRouter.put('/room/addclient', mainMiddleware, room_controller_1.roomController.addClientToRoom);
roomRouter.get('/room/:id', mainMiddleware, room_controller_1.roomController.getRoom);
roomRouter.get('/rooms/', mainMiddleware, room_controller_1.roomController.getRoomByAdmin);
roomRouter.delete('/room/:id', mainMiddleware, room_controller_1.roomController.deleteRoom);
